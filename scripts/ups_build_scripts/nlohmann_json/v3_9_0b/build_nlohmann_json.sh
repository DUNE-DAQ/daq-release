...
git clone  https://github.com/nlohmann/json.git || ssi_die "Unable to clone nlohmann_json git repo into ${PWD}"
cd ${pkgdir}/json
git checkout ${pkgtag}
...
cmake  \
    ...
    ${pkgdir}/json || ssi_die "Failed to run CMake"
...
#fi
rm -rf ${builddir}
mv ${pkgdir}/json ${product_dir}/${package}/${pkgver}/source
