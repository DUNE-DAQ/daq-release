...
class Fdreadoutmodules(CMakePackage):
    """DAQ modules for constructing readout-focused processes"""

    homepage = "https://dune-daq-sw.readthedocs.io/en/latest/packages/fdreadoutmodules/"
    git      = "https://github.com/DUNE-DAQ/fdreadoutmodules.git"
