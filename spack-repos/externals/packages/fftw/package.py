...
class FftwBase(AutotoolsPackage):
    ...
    def patch(self):
        ...
        copy(join_path(os.path.dirname(__file__),
             "fftwConfig.cmake"), "fftwConfig.cmake")
        copy(join_path(os.path.dirname(__file__),
             "fftwConfigVersion.cmake"), "fftwConfigVersion.cmake")
        copy(join_path(os.path.dirname(__file__),
             "fftwTargets.cmake"), "fftwTargets.cmake")
    ...
    def install(self, spec, prefix):
        ...
        install('fftwConfig.cmake',prefix)
        install('fftwConfigVersion.cmake',prefix)
        install('fftwTargets.cmake',prefix)
