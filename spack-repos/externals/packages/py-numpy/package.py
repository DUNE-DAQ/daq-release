...
class PyNumpy(PythonPackage):
    ...
    # JCF, Dec-29-2025: this package.py is vendored from the builtin area
    # of Spack 0.23.1, but since right now I'm working with 0.22.0 I need
    # to comment out the compiler-as-dependency lines
