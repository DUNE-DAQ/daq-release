...
class Glib(MesonPackage, AutotoolsPackage):
    ...
    # Uses distutils in gio/gdbus-2.0/codegen/utils.py JCF,

    # Dec-17-2025: add this line from the spack-packages repo version
    # of the package.py which allows Python 12 for newer versions of
    # glib
